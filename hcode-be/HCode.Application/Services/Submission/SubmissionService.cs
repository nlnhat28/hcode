...
namespace HCode.Application
{
    ...
    public class SubmissionService : BaseService<SubmissionDto, Submission>, ISubmissionService
    {
        #region Fields
        /// <summary>
        /// Repo contest
        /// </summary>
        private new readonly ISubmissionRepository _repository;
        /// <summary>
        /// Cache
        /// </summary>
        ...
        public SubmissionService(ISubmissionRepository repository, ICEService ceService,
